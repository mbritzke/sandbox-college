...
%token WHILE,TRUE, FALSE, IF, ELSE, CONTINUE, FOR, BREAK
...
atribloop :  ID '=' exp {  System.out.println("\tPOPL %EDX");
...
cmd :  ID '=' exp ';' {  System.out.println("\tPOPL %EDX");
    ...
    | WHILE {
					pLoop.push(proxLoop);  proxLoop += 2;
					System.out.printf("loop_%02d:\n",pLoop.peek());
				  } 
			 '(' exp ')' {
			 							System.out.println("\tPOPL %EAX   # desvia se falso...");
											System.out.println("\tCMPL $0, %EAX");
											System.out.printf("\tJE loop_%02d\n", (int)pLoop.peek()+1);
										} 
				cmd		{
				  		System.out.printf("\tJMP loop_%02d   # terminou cmd na linha de cima\n", pLoop.peek());
							System.out.printf("loop_%02d:\n",(int)pLoop.peek()+1);
							pLoop.pop();
							}  
	| BREAK ';' {
		System.out.printf("\tJMP loop_%02d   # break\n", pLoop.peek()+1);
	}
	| CONTINUE ';' {
		System.out.printf("\tJMP loop_%02d   # continue\n", pLoop.peek());
	}
	| FOR '('  atribloop ';'
	{
					pLoop.push(proxLoop);  proxLoop += 2;
